...
//        
//        store.customerModel = CustomerModel(userId: "id", email: "name", userName: "pete", stampCards: [data])
//        store.storeModel = StoreModel(storeName: "Store", storeId: "StoreID")
//        let api = MockStampsAPI()
//        let vm = ScanningViewModel(cardApi: api, reduxStore: store)
//        
//        await vm.foundQRCode("$$", details: (storeName: "Store", card: data))
//        
//        vm.$shouldShowAlert
//            .sink { value in
...
//            .store(in: &cancellable)
//        
//        await vm.foundQRCode("StoreID", details: (storeName: "Store", card: data))
//        vm.$storeName
//            .sink { value in
