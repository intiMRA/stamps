...
struct CardCustomizationError: Error {
    let title: String
    let message: String
    static let savingError = ScanningError(title: "Unable To Save ", message: "Something went wrong while saving your card, plese check your internet connection and try again.")
}
